...
module.exports = function(gulp, IS_RELEASE_BUILD) {
  ...
  gulp.task('demos', ['docs-clean'], function() {
    var demos = [];
  ...
  function generateDemos() { 
    ...
    return gulp.src('src/{components,services}/*/')
      .pipe(through2.obj(function(folder, enc, next) {
        ...
        var name = split.pop();
        var moduleName = 'ot.' + split.pop() + '.' + name;
  ...
  gulp.task('docs-generate', ['docs-clean', 'build'], function() {
    var dgeni = new Dgeni([
      require('./config')
    ]);
  ...
  gulp.task('docs-js', ['docs-app', 'docs-html2js', 'demos', 'docs-clean', 'build'], function() {
    return gulp.src([
  ...
  gulp.task('docs-css', ['docs-app', 'docs-clean', 'build'], function() {
    return gulp.src([
